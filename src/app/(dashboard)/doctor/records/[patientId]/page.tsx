...
/**
 * Doctor — View-Only Medical Records
...
export default function DoctorRecordsPage() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .catch((err) => console.error("[DoctorRecords]", err))
    ...
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="p-6 max-w-4xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/doctor/emr/${patientId}`}>
            <Button variant="secondary" icon={<Stethoscope className="w-4 h-4" />} size="sm">
