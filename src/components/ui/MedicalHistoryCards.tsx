 ...
 * -----------------------
 * Shared collapsible history cards used on both the Nurse SOAP page
 * and the Doctor EMR page.
 *
 * Exports:
...
import {
  ...
  Pill, FlaskConical, Link as LinkIcon,
} from "lucide-react";
import { format } from "date-fns";
import { id as localeId } from "date-fns/locale";
import type { SOAPNote, DoctorNote, VitalSigns } from "@/types";
